            ...
            <div class="col-lg-10">
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white">
                    <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                        ...
                        <div>
                            <h2 class="fw-bold text-dark mb-1">Data Privacy Policy</h2>
                    ...
                    <div class="privacy-content d-flex flex-column gap-4">
                        ...
                        <section>
                            ...
                            <div class="row g-3 text-secondary small">
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-2 border">
                                        <strong><i class="bi bi-trash-fill text-danger me-1"></i> Right to Erasure / Withdraw:</strong> Cancel active job applications or request account deactivation.
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="p-3 bg-light rounded-2 border">
