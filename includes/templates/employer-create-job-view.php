<?php
/**
 * View template for employer/create-job.php
                            ...
                            <div class="reg-step-pane is-visible" id="step-pane-1">
                                <div class="card-paper p-4 p-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" id="job-title" class="form-control" placeholder="e.g. Laboratory Student Assistant" value="<?= htmlspecialchars($form['title'] ?? '') ?>" required autofocus>
                                    </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <select name="category" id="job-category" class="form-select" required>
                                                <option value="" disabled <?= empty($form['category']) ? 'selected' : '' ?>>Select Job Category...</option>
                                                <?php foreach ($categories as $cat): ?>
                                                    <option value="<?= htmlspecialchars($cat['name']) ?>" <?= (isset($form['category']) && $form['category'] === $cat['name']) ? 'selected' : '' ?>><?= htmlspecialchars($cat['name']) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="job_type" id="job-type" class="form-select" required>
                                                <option value="" disabled <?= empty($form['job_type']) ? 'selected' : '' ?>>Select Opportunity Type...</option>
                                                <?php foreach ($job_types as $k => $label): ?>
                                                    <option value="<?= htmlspecialchars($k) ?>" <?= (isset($form['job_type']) && $form['job_type'] === $k) ? 'selected' : '' ?>><?= htmlspecialchars($label) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="work_setup" id="work-setup" class="form-select" required>
                                                <option value="" disabled <?= empty($form['work_setup']) ? 'selected' : '' ?>>Select Workplace Setup...</option>
                                                <?php foreach ($work_setups as $k => $label): ?>
                                                    <option value="<?= htmlspecialchars($k) ?>" <?= (isset($form['work_setup']) && $form['work_setup'] === $k) ? 'selected' : '' ?>><?= htmlspecialchars($label) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="description" id="job-desc" rows="4" class="form-control" placeholder="Describe the overall purpose, daily duties, schedule flexibility, and office working environment..." required><?= htmlspecialchars($form['description'] ?? '') ?></textarea>
                                    </div>
                                ...
                                <div class="card-paper p-4 p-md-4">
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="department" id="job-dept" class="form-control" placeholder="e.g. Office of the University Registrar" value="<?= htmlspecialchars($form['department'] ?? ($user['organization_name'] ?? ($user['department'] ?? ''))) ?>" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label" for="job-loc">Physical / Office Location <span class="text-danger">*</span></label>
                                            <input type="text" name="location" id="job-loc" class="form-control" placeholder="e.g. KLD Admin Building, 1st Floor, Room 1" value="<?= htmlspecialchars($form['location'] ?? ($user['office_location'] ?? '')) ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="vacancies" id="job-vac" class="form-control" placeholder="e.g. 2" min="1" max="50" value="<?= htmlspecialchars($form['vacancies'] ?? '') ?>" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label" for="job-hours">Weekly Limit <span class="text-danger">*</span></label>
                                            <?php $cur_hours = $form['hours_per_week'] ?? '10 - 20 hrs/week'; ?>
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" name="deadline" id="job-deadline" class="form-control" min="<?= date('Y-m-d') ?>" value="<?= htmlspecialchars($form['deadline'] ?? '') ?>" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label" for="job-tags">Tags (Comma-separated)</label>
                                            <input type="text" name="tags" id="job-tags" class="form-control" placeholder="e.g. Flexible Schedule, Urgent, IT Support" value="<?= htmlspecialchars($form['tags'] ?? '') ?>">
                                        </div>
                                    </div>
