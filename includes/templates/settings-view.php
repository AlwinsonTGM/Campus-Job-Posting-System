<?php
/**
 * View template for settings.php
            ...
            <div class="container-paper">
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-lg-7">
                        ...
                        <?php if (($user['role'] ?? '') === 'admin'): ?>
                            <?php
                            $current_data_mode = function_exists('get_system_data_mode') ? $view_get_system_data_mode : 'demo';
                    ...
                    <div class="col-md-6 border-end-md border-line pe-md-3">
                        ...
                        <div class="mb-2">
                            ...
                            <select name="department" id="req-dept" class="form-select form-select-sm" required>
                                ...
                                <?php foreach ($view_get_kld_institutes_and_courses as $inst => $courses): ?>
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-7">
                                ...
                                <select name="year_level" id="req-year-level" class="form-select form-select-sm" required>
                                    <?php foreach ($view_get_year_levels as $val => $label): ?>
                            ...
                            <div class="col-5">
                                ...
                                <select name="sex" id="req-sex" class="form-select form-select-sm" required>
                                    ...
                                    <?php foreach ($view_get_sex_options as $val => $label): ?>
