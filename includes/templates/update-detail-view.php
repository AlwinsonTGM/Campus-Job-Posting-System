<?php
/**
 * View template for update-detail.php
                    ...
                    <div class="article-reader-wrap">
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-3 pb-5 mb-5 border-bottom border-line">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($share_url) ?>" target="_blank" rel="noopener noreferrer" class="social-circle-link" title="Share on Facebook">
