<?php
/**
 * Campus Job Posting System - Registration View
 * Pure HTML/PHP echo template. Controller: register.php
 * Data preloaded: $kld_institutes, $year_levels_list, $sex_options_list,
 *   $is_other_institute_selected, $other_institute_value
 * Inline <script> blocks intentionally stay in this template.
 */
                                ...
                                <div class="row g-3 mb-3" id="student-fields">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="department" class="form-select" id="department-select" onchange="checkOtherInstitute(this.value)">
                                            ...
                                            <?php foreach ($kld_institutes as $inst => $courses): ?>
                                                <option value="<?= htmlspecialchars($inst) ?>" <?= (isset($department) && $department === $inst) ? 'selected' : '' ?>><?= htmlspecialchars($inst) ?></option>
                                            <?php endforeach; ?>
                                            <option value="Other Institute / Outsider" <?= $is_other_institute_selected ? 'selected' : '' ?>>Other Institute / Outsider</option>
                                        </select>
                                    </div>
                                    <div class="col-12" id="other-institute-wrap" style="display: <?= $is_other_institute_selected ? 'block' : 'none' ?>;">
                                        <label class="form-label" for="other_institute">Specify Institute / University Name <span class="text-danger">*</span></label>
                                        <input type="text" name="other_institute" id="other_institute" class="form-control" placeholder="e.g. Cavite State University, De La Salle..." value="<?= htmlspecialchars($other_institute_value) ?>">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="year_level" id="year_level" class="form-select" required>
                                            ...
                                            <?php foreach ($year_levels_list as $val => $label): ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="sex" id="reg-sex" class="form-select">
                                            ...
                                            <?php foreach ($sex_options_list as $val => $label): ?>
