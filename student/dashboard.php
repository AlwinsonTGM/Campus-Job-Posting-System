            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <div>
                            <span class="badge bg-warning text-dark text-uppercase small">Student Portal</span>
                            <h3 class="fw-bold text-white mb-0">Welcome back, <?= htmlspecialchars($user['name']) ?>!</h3>
                        </div>
                    </div>
                        ...
                        <?php foreach ($recommended_jobs as $job): ?>
                            <div class="p-3 rounded-3 border">
                                ...
                                <div class="d-flex justify-content-between align-items-center small">
                                    <span class="text-secondary"><i class="bi bi-clock me-1"></i><?= htmlspecialchars($job['hours_per_week']) ?></span>
                                    <a href="apply.php?job_id=<?= $job['id'] ?>" class="btn btn-sm btn-outline-academic py-0 px-2">Apply</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
